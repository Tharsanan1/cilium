...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *BackendTrafficPolicy) DeepEqual(other *BackendTrafficPolicy) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *BackendTrafficPolicySpec) DeepEqual(other *BackendTrafficPolicySpec) bool {
	if other == nil {
		return false
	}

	if (in.RateLimit == nil) != (other.RateLimit == nil) {
		return false
	} else if in.RateLimit != nil {
		if !in.RateLimit.DeepEqual(other.RateLimit) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ClaimToHeader) DeepEqual(other *ClaimToHeader) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *GlobalRateLimit) DeepEqual(other *GlobalRateLimit) bool {
	if other == nil {
		return false
	}
...
func (in *HeaderMatch) DeepEqual(other *HeaderMatch) bool {
	...
	if (in.Value == nil) != (other.Value == nil) {
		return false
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *JWT) DeepEqual(other *JWT) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *JWTExtractor) DeepEqual(other *JWTExtractor) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *JWTHeaderExtractor) DeepEqual(other *JWTHeaderExtractor) bool {
	if other == nil {
		return false
	}
	...
	if (in.ValuePrefix == nil) != (other.ValuePrefix == nil) {
		return false
	} else if in.ValuePrefix != nil {
		if *in.ValuePrefix != *other.ValuePrefix {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *JWTProvider) DeepEqual(other *JWTProvider) bool {
	if other == nil {
		return false
	}
	...
	if in.RemoteJWKS != other.RemoteJWKS {
		return false
	}
	...
	if (in.RecomputeRoute == nil) != (other.RecomputeRoute == nil) {
		return false
	} else if in.RecomputeRoute != nil {
		if *in.RecomputeRoute != *other.RecomputeRoute {
			return false
		}
	}

	if (in.ExtractFrom == nil) != (other.ExtractFrom == nil) {
		return false
	} else if in.ExtractFrom != nil {
		if !in.ExtractFrom.DeepEqual(other.ExtractFrom) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *LocalRateLimit) DeepEqual(other *LocalRateLimit) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RateLimitRule) DeepEqual(other *RateLimitRule) bool {
	if other == nil {
		return false
	}

	if ((in.ClientSelectors != nil) && (other.ClientSelectors != nil)) || ((in.ClientSelectors == nil) != (other.ClientSelectors == nil)) {
		in, other := &in.ClientSelectors, &other.ClientSelectors
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RateLimitSelectCondition) DeepEqual(other *RateLimitSelectCondition) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RateLimitSpec) DeepEqual(other *RateLimitSpec) bool {
	if other == nil {
		return false
	}
	...
	if (in.Global == nil) != (other.Global == nil) {
		return false
	} else if in.Global != nil {
		if !in.Global.DeepEqual(other.Global) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RateLimitValue) DeepEqual(other *RateLimitValue) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RemoteJWKS) DeepEqual(other *RemoteJWKS) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *SecurityPolicy) DeepEqual(other *SecurityPolicy) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *SecurityPolicySpec) DeepEqual(other *SecurityPolicySpec) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *SourceMatch) DeepEqual(other *SourceMatch) bool {
	if other == nil {
		return false
	}
