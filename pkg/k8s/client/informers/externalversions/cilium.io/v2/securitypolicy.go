...
type SecurityPolicyInformer interface {
	...
	Lister() v2.SecurityPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CiliumV2().SecurityPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CiliumV2().SecurityPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&ciliumiov2.SecurityPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *securityPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ciliumiov2.SecurityPolicy{}, f.defaultInformer)
}

func (f *securityPolicyInformer) Lister() v2.SecurityPolicyLister {
	return v2.NewSecurityPolicyLister(f.Informer().GetIndexer())
}
